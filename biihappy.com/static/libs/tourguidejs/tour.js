! function(t, e) {
    ...
    var t = {
            362: (t, e, i) => {
                ...
                async function d(t, e) {
                    ...
                    const {
                        ...
                        altBoundary: h = !1,
                        padding: g = 0
                    } = e, m = l(g), v = a[h ? "floating" === p ? "reference" : "floating" : p], y = c(await r.getClippingRect({
                        ...
                        rootBoundary: f,
                        strategy: d
                    })), b = c(r.convertOffsetParentRelativeRectToViewportRelativeRect ? await r.convertOffsetParentRelativeRectToViewportRelativeRect({
                        rect: "floating" === p ? { ...s.floating,
                            x: n,
                            y: o
                        } : s.reference,
                ...
                function v(t, e, i) {
                    ...
                    return e.reference[l] > e.floating[l] && (c = m(c)), {
                        main: c,
                        cross: m(c)
                    }
                }
                    ...
                    k = function(t) {
                        return void 0 === t && (t = {}), {
                            ...
                            async fn(e) {
                                ...
                                }(y, k, w), S = await d(e, E), P = null != (i = null == (r = p.autoPlacement) ? void 0 : r.index) ? i : 0, L = _[P];
                                if (null == L) return {};
                                const {
                                    main: C,
                                    cross: O
                                } = v(L, f, await (null == g.isRTL ? void 0 : g.isRTL(m.floating)));
                                if (h !== L) return {
                                    x: c,
                                    y: u,
                                    reset: {
                                ...
                                const B = [S[n(L)], S[C], S[O]],
                                    A = [...null != (s = null == (a = p.autoPlacement) ? void 0 : a.overflows) ? s : [], {
                                        placement: L,
                                        overflows: B
                                    }],
                                    D = _[P + 1];
                        ...
                        return void 0 === t && (t = {}), {
                            ...
                            async fn(e) {
                                ...
                                const {
                                    ...
                                    flipAlignment: g = !0,
                                    ...y
                                } = t, w = n(o), x = p || (w !== a && g ? function(t) {
                                    const e = m(t);
                                    return [b(t), e, b(e)]
                                }(a) : [m(a)]), k = [a, ...x], E = await d(e, y), _ = [];
                                let S = (null == (i = r.flip) ? void 0 : i.overflows) || [];
                                if (u && _.push(E[w]), f) {
                                    const {
                                        main: t,
                                        cross: e
                                    } = v(o, s, await (null == l.isRTL ? void 0 : l.isRTL(c.floating)));
                                    _.push(E[t], E[e])
                                }
                                if (S = [...S, {
                                        placement: o,
                                    ...
                                    switch (h) {
                                        case "bestFit":
                                            {
                                                var C;
                                                const t = null == (C = S.map((t => [t, t.overflows.filter((t => t > 0)).reduce(((t, e) => t + e), 0)])).sort(((t, e) => t[1] - e[1]))[0]) ? void 0 : C[0].placement;t && (i = t);
                                                break
                                            }
                            ...
                            async fn(e) {
                                const {
                                    ...
                                    const {
                                        ...
                                        platform: s,
                                        elements: a
                                    } = t, l = await (null == s.isRTL ? void 0 : s.isRTL(a.floating)), c = n(i), d = o(i), u = "x" === r(i), f = ["left", "top"].includes(c) ? -1 : 1, p = l && u ? -1 : 1, h = "function" == typeof e ? e(t) : e;
                                    let {
                                        mainAxis: g,
                                        crossAxis: m,
                                        alignmentAxis: v
                                    ...
                                    return d && "number" == typeof v && (m = "end" === d ? -1 * v : v), u ? {
                                        x: m * p,
                                        y: g * f
                                    } : {
                                        x: g * f,
                        ...
                        return void 0 === t && (t = {}), {
                            ...
                            async fn(e) {
                                const {
                                    ...
                                    apply: l = (() => {}),
                                    ...c
                                } = t, u = await d(e, c), p = n(i), h = o(i);
                                let g, m;
                                "top" === p || "bottom" === p ? (g = p, m = h === (await (null == s.isRTL ? void 0 : s.isRTL(a.floating)) ? "start" : "end") ? "left" : "right") : (m = p, g = "end" === h ? "top" : "bottom");
                                const v = f(u.left, 0),
                                    y = f(u.right, 0),
                                    b = f(u.top, 0),
                                    w = f(u.bottom, 0),
                                ...
                                return r.floating.width !== k.width || r.floating.height !== k.height ? {
                                    reset: {
                                        rects: !0
                                    }
                                } : {}
                        ...
                        return void 0 === t && (t = {}), {
                            ...
                            async fn(e) {
                                ...
                                const {
                                    ...
                                    x: g,
                                    y: m
                                } = t, v = c(d.convertOffsetParentRelativeRectToViewportRelativeRect ? await d.convertOffsetParentRelativeRectToViewportRelativeRect({
                                    rect: a.reference,
                                    offsetParent: await (null == d.getOffsetParent ? void 0 : d.getOffsetParent(s.floating)),
                                    strategy: p
                                }) : a.reference), y = null != (i = await (null == d.getClientRects ? void 0 : d.getClientRects(s.reference))) ? i : [], b = l(h), w = await d.getElementRects({
                                    reference: {
                                        getBoundingClientRect: function() {
                                            var t;
                                            if (2 === y.length && y[0].left > y[1].right && null != g && null != m) return null != (t = y.find((t => g > t.left - b.left && g < t.right + b.right && m > t.top - b.top && m < t.bottom + b.bottom))) ? t : v;
                                            if (y.length >= 2) {
                                                if ("x" === r(o)) {
                                                    const t = y[0],
                                                        e = y[y.length - 1],
                                ...
                                return a.reference.x !== w.reference.x || a.reference.y !== w.reference.y || a.reference.width !== w.reference.width || a.reference.height !== w.reference.height ? {
                                    reset: {
                                        rects: w
                                    }
                                } : {}
                ...
                function N(t) {
                    const e = /firefox/i.test(j()),
                        i = M(t);
                    return "none" !== i.transform || "none" !== i.perspective || e && "filter" === i.willChange || e && !!i.filter && "none" !== i.filter || ["transform", "perspective"].some((t => i.willChange.includes(t))) || ["paint", "layout", "strict", "content"].some((t => {
                        const e = i.contain;
                ...
                function it(t) {
                    ...
                    return i && ("html" === H(i) || "body" === H(i) && "static" === M(i).position && !N(i)) ? e : i || function(t) {
                        let e = tt(t);
                ...
                function st(t, e, i) {
                    return "viewport" === e ? c(function(t, e) {
                        const i = R(t),
                            n = Z(t),
                            o = i.visualViewport;
                        let r = n.clientWidth,
                        ...
                        const l = -n.scrollTop;
                        return "rtl" === M(o || i).direction && (a += X(i.clientWidth, o ? o.clientWidth : 0) - r), {
                            width: r,
                            height: s,
                            x: a,
                            y: l
                ...
                function at(t) {
                    ...
                    return W(n) ? e.filter((t => n && W(t) && function(t, e) {
                ...
                function ct(t, e, i, n) {
                    ...
                    return a && function e() {
                        ...
                        })), null == (t = u) || t.disconnect(), u = null, a && cancelAnimationFrame(d)
                    }
                }
                const dt = (t, e, i) => (async (t, e, i) => {
                    const {
                        placement: n = "bottom",
                        strategy: o = "absolute",
                        middleware: r = [],
                        platform: s
                    } = i, l = await (null == s.isRTL ? void 0 : s.isRTL(e));
                    ...
                    for (let i = 0; i < r.length; i++) {
                        ...
                        d = null != v ? v : d, u = null != y ? y : u, p = { ...p,
                            [g]: { ...p[g],
                                ...b
                            }
                        }, w && h <= 50 && (h++, "object" == typeof w && (w.placement && (f = w.placement), w.rects && (c = !0 === w.rects ? await s.getElementRects({
                            reference: t,
                            floating: e,
                            strategy: o
                        }) : w.rects), ({
            ...
            797: function(t, e, i) {
                ...
                e.TourGuideClient = class {
                    constructor(t) {
                        ...
                        }, this.onFinish = d.handleOnFinish, this.onBeforeExit = d.handleOnBeforeExit, this.onAfterExit = d.handleOnAfterExit, this.onBeforeStepChange = d.handleOnBeforeStepChange, this.onAfterStepChange = d.handleOnAfterStepChange, this.dialog = document.createElement("div"), this.backdrop = document.createElement("div"), this.options = b.default, t && Object.assign(this.options, t), this.createTourGuideDialog().catch((t => {
            ...
            319: (t, e) => {
                Object.defineProperty(e, "__esModule", {
                    value: !0
                }), e.computeBackdropPosition = e.computeBackdropAttributes = e.createTourGuideBackdrop = void 0, e.createTourGuideBackdrop = function() {
                    ...
                    return new Promise((async (e, i) => {
                        ...
                        } else n.fixed ? (t.backdrop.style.position = "fixed", t.backdrop.style.top = r.top - t.options.targetPadding / 2 + "px", t.backdrop.style.left = (s ? r.x : r.x - t.options.targetPadding / 2) + "px") : (t.backdrop.style.position = "absolute", t.backdrop.style.top = window.scrollY + r.top - t.options.targetPadding / 2 + "px", t.backdrop.style.left = (s ? r.x : r.x - t.options.targetPadding / 2) + "px");
            ...
            166: (t, e) => {
                Object.defineProperty(e, "__esModule", {
                    value: !0
                }), e.handleOnAfterStepChange = e.handleOnBeforeStepChange = e.handleOnAfterExit = e.handleOnBeforeExit = e.handleOnFinish = void 0, e.handleOnFinish = function(t) {
            ...
            693: (t, e, i) => {
                Object.defineProperty(e, "__esModule", {
                    value: !0
                }), e.computeDialogPosition = e.updateDialogHtml = e.renderDialogHtml = e.createTourGuideDialog = void 0;
                const n = i(500),
                    o = i(362);
                async function r(t) {
                    t.options.dialogClass && t.dialog.classList.add(t.options.dialogClass), t.options.dialogZ && (t.dialog.style.zIndex = String(t.options.dialogZ)), t.dialog.style.width = t.options.dialogWidth ? t.options.dialogWidth + "px" : "auto", t.options.dialogMaxWidth && (t.dialog.style.maxWidth = t.options.dialogMaxWidth + "px");
                    let e = "";
                    if (e += "<div class='tg-dialog-header'>", e += '<div class="tg-dialog-title" id="tg-dialog-title">\x3c!-- JS rendered --\x3e</div>', t.options.closeButton && (e += '<div class="tg-dialog-close-btn" id="tg-dialog-close-btn">', e += ' <svg width="12px" height="12px" id="Layer_1" version="1.1" viewBox="0 0 512 512" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path d="M443.6,387.1L312.4,255.4l131.5-130c5.4-5.4,5.4-14.2,0-19.6l-37.4-37.6c-2.6-2.6-6.1-4-9.8-4c-3.7,0-7.2,1.5-9.8,4  L256,197.8L124.9,68.3c-2.6-2.6-6.1-4-9.8-4c-3.7,0-7.2,1.5-9.8,4L68,105.9c-5.4,5.4-5.4,14.2,0,19.6l131.5,130L68.4,387.1  c-2.6,2.6-4.1,6.1-4.1,9.8c0,3.7,1.4,7.2,4.1,9.8l37.4,37.6c2.7,2.7,6.2,4.1,9.8,4.1c3.5,0,7.1-1.3,9.8-4.1L256,313.1l130.7,131.1  c2.7,2.7,6.2,4.1,9.8,4.1c3.5,0,7.1-1.3,9.8-4.1l37.4-37.6c2.6-2.6,4.1-6.1,4.1-9.8C447.7,393.2,446.2,389.7,443.6,387.1z"/></svg>', e += "</div>"), e += "</div>", t.options.progressBar && (e += '<div class="tg-dialog-progress-bar"><span class="tg-bar" id="tg-dialog-progbar"></span></div>'), e += '<div class="tg-dialog-body" id="tg-dialog-body">\x3c!-- JS rendered --\x3e</div>', t.options.showStepDots && "body" === t.options.stepDotsPlacement) {
                    ...
                    let i = "tg-dialog-btn",
                        o = "false";
                    if (0 === t.activeStep && (o = "true", i += " disabled"), t.options.showButtons && !t.options.hidePrev && (e += '<button type="button" class="' + i + '" id="tg-dialog-prev-btn" disabled="' + o + `">${t.options.prevLabel}</button>`), e += '<div class="tg-dialog-footer-sup">', t.options.showStepDots && "footer" === t.options.stepDotsPlacement) {
                        const t = (0, n.dotsWrapperHtmlString)();
                        t && (e += t)
                    }
                    return t.options.showStepProgress && (e += '<span class="tg-step-progress" id="tg-step-progress">\x3c!-- JS rendered --\x3e</span>'), e += "</div>", t.options.showButtons && !t.options.hideNext && (e += `<button type="button" class="tg-dialog-btn" id="tg-dialog-next-btn">${t.options.nextLabel}</button>`), e += "</div>", e += '<div id="tg-arrow" class="tg-arrow"></div>\x3c!-- end tour arrow --\x3e', e
                }
                e.createTourGuideDialog = async function() {
                    return this.dialog = document.createElement("div"), this.dialog.classList.add("tg-dialog"), await r(this).then((t => {
                        this.dialog.innerHTML = t
                    })), document.body.append(this.dialog), !0
                }, e.renderDialogHtml = r, e.updateDialogHtml = function(t) {
                    ...
                    return new Promise((async e => {
                        ...
                        if (n === document.body) return Object.assign(t.dialog.style, {
                            top: window.innerHeight / 2.25 - t.dialog.clientHeight / 2 + "px",
                            left: window.innerWidth / 2 - t.dialog.clientWidth / 2 + "px",
                            position: "fixed"
                        }), t.dialog.classList.add("tg-dialog-fixed"), i && (i.style.display = "none"), e(!0);
                        t.dialog.style.position = "absolute", t.dialog.classList.remove("tg-dialog-fixed"), i && (i.style.display = "inline-block"), (0, o.computePosition)(n, t.dialog, {
                            placement: t.options.dialogPlacement,
                            middleware: [(0, o.autoPlacement)({
                                autoAlignment: !0,
                                padding: 5
                            }), (0, o.shift)({
                                padding: 15
                            ...
                            if (Object.assign(t.dialog.style, {
                                    left: `${n}px`,
                                    top: `${o}px`
                                }), s.arrow) {
                                const t = s.arrow.x,
            ...
            500: (t, e) => {
                Object.defineProperty(e, "__esModule", {
                    value: !0
                }), e.computeDots = e.dotsWrapperHtmlString = void 0, e.dotsWrapperHtmlString = function() {
                    const t = document.createElement("div");
                    return t.classList.add("tg-dialog-dots"), t.id = "tg-dialog-dots", t.outerHTML
                }, e.computeDots = t => {
                    let e = "";
                    return t.tourSteps.length && t.tourSteps.forEach(((i, n) => {
            ...
            737: (t, e) => {
                Object.defineProperty(e, "__esModule", {
                    value: !0
                }), e.keyPressHandler = e.clickOutsideHandler = e.handleDestroyListeners = e.handleInitListeners = void 0, e.clickOutsideHandler = async function(t) {
                    ...
                    return "Escape" === t.key && this.options.exitOnEscape ? (t.preventDefault(), void await this.exit()) : "ArrowRight" === t.key && this.options.keyboardControls ? (t.preventDefault(), void this.visitStep("next").catch((t => {
                        this.options.debug && console.warn(t)
                    }))) : "ArrowLeft" === t.key && this.options.keyboardControls ? (t.preventDefault(), void this.visitStep("prev").catch((t => {
                        this.options.debug && console.warn(t)
                    }))) : void 0
                    ...
                    return new Promise((r => (this.options.showButtons && t(), this.options.showButtons && e(), this.options.closeButton && i(), this.options.exitOnClickOutside && n(), (this.options.keyboardControls || this.options.exitOnEscape) && o(), r(!0))))
            ...
            121: (t, e, i) => {
                ...
                e.default = function() {
                    return new Promise((async t => {
                        ...
                        }), 300), this.isVisible = !0, window.onresize || (window.onresize = () => {
                ...
                Object.defineProperty(e, "__esModule", {
                    ...
                    return new Promise((async (e, i) => {
                        ...
                        return o && o.forEach((e => {
                            ...
                            t.options.targetPadding && t.options.autoScrollOffset ? e.style.scrollMargin = (l ? l + t.options.targetPadding : t.options.autoScrollOffset + t.options.targetPadding) + "px 0" : e.style.scrollMargin = (l || "30") + "px 0", n.push({
                                title: i || void 0,
                        ...
                        })), t.group && (n = n.filter((e => e.group === t.group))), n.sort((function(t, e) {
                            return new Date(t.order) < new Date(e.order) ? -1 : 1
                        })), t.tourSteps = n, t.tourSteps.length ? e(!0) : i("No tour steps detected" + (t.group ? " in group: " + t.group : ""))
                    }))
                }
            },
            971: function(t, e, i) {
                ...
                const o = n(i(755)),
                    ...
                    s = n(i(570));
                e.default = async function(t) {
                    this.options.steps && (this.options.steps.push(...t), await (0, o.default)(this), this.isVisible && await (0, r.updateDialogHtml)(this).catch((t => {
                        this.options.debug && console.warn(t)
                    })), this.isVisible && this.updatePositions().catch((t => {
                        this.options.debug && console.warn(t)
            ...
            544: (t, e) => {
                Object.defineProperty(e, "__esModule", {
                    ...
                    this.dialog.style.display = "none", this.backdrop.style.display = "none", this.isVisible = !1, this.options.rememberStep || (this.activeStep = 0), this.options.debug && console.info("Tour exited"), await this.destroyListeners(), setTimeout((() => {
            ...
            283: (t, e) => {
                Object.defineProperty(e, "__esModule", {
                    value: !0
                }), e.delFinishedTour = e.getIsFinished = void 0, e.getIsFinished = function(t = "tour") {
                    ...
                    if (this.options.completeOnFinish) {
                        if (!localStorage.tg_tours_complete) return void(localStorage.tg_tours_complete = [e]);
                        const t = localStorage.tg_tours_complete.split(",");
                        t.push(e), localStorage.tg_tours_complete = t
                    }
            ...
            612: function(t, e, i) {
                ...
                e.handleRefreshDialog = async function() {
                    return new Promise((async (t, e) => (await (0, r.renderDialogHtml)(this).then((t => {
                        t && (this.dialog.innerHTML = t)
                    })).catch((t => {
                        this.options.debug && console.warn(t)
                    })), await (0, r.updateDialogHtml)(this).catch((t => {
                        this.options.debug && console.warn(t), e(t)
                    })), await this.updatePositions(), this.isVisible && await (0, s.default)(".tg-dialog").then((async () => (await this.destroyListeners(), await this.initListeners(), !0))), t(!0))))
                }, e.default = async function() {
            ...
            340: function(t, e, i) {
                ...
                const o = i(693),
                    r = n(i(570));
                e.default = async function(t) {
                    if (t) return Object.assign(this.options, t), this.computeBackdropAttributes(), await (0, o.renderDialogHtml)(this).then((t => {
                        t && (this.dialog.innerHTML = t)
                    })).catch((t => {
                        this.options.debug && console.warn(t)
                    })), await (0, o.updateDialogHtml)(this).catch((t => {
                        this.options.debug && console.warn(t)
                    })), this.isVisible && await (0, r.default)(".tg-dialog").then((async () => (await this.destroyListeners(), await this.initListeners(), !0))), this
                }
            },
            330: function(t, e, i) {
                var n = this && this.__importDefault || function(t) {
                ...
                e.default = async function(t) {
                    return new Promise((async (e, i) => {
                        ...
                        return await n.visitStep(this.activeStep).catch((t => (this.options.debug && console.warn(t), i(t)))), await (0, o.default)(".tg-dialog").then((async () => {
            ...
            483: function(t, e, i) {
                ...
                Object.defineProperty(e, "__esModule", {
                    value: !0
                }), e.handleVisitPrevStep = e.handleVisitNextStep = e.goToStep = void 0;
                const o = i(693),
                    r = n(i(830));
                ...
                function s(t, e) {
                    return new Promise((async (i, n) => {
                        ...
                        if (t._globalBeforeChangeCallback && e !== s) try {
                            await t._globalBeforeChangeCallback()
                        } catch (t) {
                            return n(t)
                        }
                        if (a.beforeLeave) try {
                            await a.beforeLeave(a, l)
                        } catch (t) {
                            return n(t)
                        }
                        if (l.beforeEnter) try {
                            await l.beforeEnter(a, l)
                        } catch (t) {
                            return n(t)
                        }
                        return "string" == typeof l.target && (t.tourSteps[e].target = document.querySelector(l.target)), l.target && t.tourSteps[e].target || (t.tourSteps[e].target = document.body), t.activeStep = Number(e), await (0, o.updateDialogHtml)(t).catch((e => {
                            t.options.debug && console.warn(e), n(e)
                        })), t.options.autoScroll && l.target !== document.body && await (0, r.default)(t, l.target), await t.updatePositions(), a.afterLeave && await a.afterLeave(a, l), l.afterEnter && await l.afterEnter(a, l), t._globalAfterChangeCallback && e !== s && await t._globalAfterChangeCallback(), i(!0)
                    }))
                }
                ...
                }, e.goToStep = s, e.default = async function(t) {
                    return new Promise((async (e, i) => {
