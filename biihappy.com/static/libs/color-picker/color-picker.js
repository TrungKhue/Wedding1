/*! Color-Picker 0.12.0 MIT | https://github.com/yairEO/color-picker */ ! function(t, e) {
    "object" == typeof exports && "undefined" != typeof module ? e(exports) : "function" == typeof define && define.amd ? define(["exports"], e) : e((t = "undefined" != typeof globalThis ? globalThis : t || self).ColorPicker = {})
}(this, (function(t) {
    "use strict";
    ...
    const i = t => t.match(/\((.*)\)/)[1].split(",").map(Number),
        o = t => Object.assign([0, 0, 0, 1], t.match(/\((.*)\)/)[1].split(",").map(((t, e) => 3 != e || t.includes("%") ? parseFloat(t) : 100 * parseFloat(t)))),
        a = t => `hsla(${t.h}, ${t.s}%, ${t.l}%, ${t.a}%)`,
        n = t => t.toFixed(1).replace(".0", ""),
        h = t => {
            const [e, s, i, o] = (t => t.match(/\w\w/g))(t), [a, n, h] = [e, s, i].map((t => parseInt(t, 16)));
            return `rgba(${a},${n},${h},${o?(parseInt(o,16)/255).toFixed(2):1})`
        },
        r = t => {
            var e, s = document.createElement("canvas").getContext("2d");
            return s.fillStyle = t, "#" == (e = s.fillStyle)[0] ? e : l(e)
        },
        l = t => {
            const [e, s, o, a] = i(t), n = "#" + [e, s, o].map((t => t.toString(16).padStart(2, "0"))).join("");
        ...
        c = t => {
            ...
            return l && (u = d > .5 ? l / (2 - h - r) : l / (h + r), c = h == e ? (s - o) / l + (s < o ? 6 : 0) : c = h == s ? (o - e) / l + 2 : (e - s) / l + 4, c /= 6), {
                h: n(360 * c),
                s: n(100 * u),
                l: n(100 * d),
                a: n(100 * a)
        ...
        u = (t, e) => (e = (e + "").toLowerCase(), t = r(t), "hex" == e ? t : e.startsWith("hsl") ? a(c(h(t))) : e.startsWith("rgb") ? h(t) : t);
    ...
    function w(t) {
        ...
        const {
            value: e,
            max: s
        } = t.target, i = -1 * Math.sign(t.deltaY);
    ...
    var $ = Object.freeze({
        ...
        bindEvents: function() {
            [
                ...
                ["scope", "wheel", w],
                ["value", "change", y]
            ].forEach((([t, e, s]) => this.DOM[t].addEventListener(e, s.bind(this), {
                pasive: !1
    ...
    var k = Object.freeze({
        ...
        getSetGlobalSwatches: function(t) {
            const e = this.settings.swatchesLocalStorage,
                s = "string" == typeof e ? e : "";
            return e && t && (localStorage.setItem(D + s, t.join(";")), dispatchEvent(new Event("storage"))), localStorage[D + s] ? .split(";").filter(String) || []
        },
    ...
    function F(t) {
        ...
        this.DOM = {}, this.sharedSwatches = this.getSetGlobalSwatches(), this.initialSwatches = o || [], this.swatches = o && this.sharedSwatches.concat(this.initialSwatches), this.color = u(e, i), this.history = M.call(this), this.init()
    }
    F.prototype = {
        templates: g,
        ...k,
        ...
        getHSLA(t) {
            let e;
            if (t) return t + "" == "[object Object]" && Object.keys(t).join("").startsWith("hsl") ? t : (this.colorFormat = this.getColorFormat(t), t.indexOf("hsla") ? (t = r(t), t = h(t), e = c(t)) : (e = o(t), e = {
                h: e[0],
                s: e[1],
                l: e[2],
                a: e[3]
        ...
        setCSSColor() {
            this.CSSColor = r(a(this.color)), "rgba" == this.colorFormat ? this.CSSColor = h(this.CSSColor) : "hsla" == this.colorFormat && (this.CSSColor = a(this.color)), this.DOM.scope && this.DOM.scope.setAttribute("data-color-format", this.colorFormat), this.settings.onInput(this.CSSColor)
        },
        setColor(t) {
    ...
    }, t.CSStoHSLA = o, t.HSLAtoCSS = a, t.any_to_hex = r, t.changeColorFormat = u, t.default = F, t.hex_rgba = h, t.rgba_hsla = c, Object.defineProperty(t, "__esModule", {
        value: !0
    })
}));
